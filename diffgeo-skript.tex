...
Now, with this knowledge we can take the dot-product of $\vec{KP} = (p-k, p^2) = (k, 4k^2)$ and $\vec{KF} = (-k, \frac{1}{4})$.

\begin{equation*}
\left\langle\vec{KP}, \vec{KF}\right\rangle = -k^2 + \frac{4}{4}k^2 = 0
\end{equation*}
